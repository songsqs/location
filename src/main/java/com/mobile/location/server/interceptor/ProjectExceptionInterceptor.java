package com.mobile.location.server.interceptor;

import static com.mobile.location.server.common.util.Constant.LOG_SPLIT;
...
import com.mobile.location.server.common.util.RequestUtil;

/**
 * 拦截http请求响应异常 ProjectExceptionInterceptor
 * 
 * @author songqingshan
 ...
 */
@ControllerAdvice
public class ProjectExceptionInterceptor {

	private static final Logger logger = LoggerFactory.getLogger(ProjectExceptionInterceptor.class);
	...
	@ResponseBody
	public Result<Void> handlerCloudFileException(ProjectException e, HttpServletRequest request,
